  ...
  useEffect(() => {
    if (courseCode != null) {
      ...
      fetch(queryString)
        .then((res) => res.json())
        .then((res) => {
          if (res.length > 0) setCourse(res[0] as Course);
        });
    }
    ...
    <div>
      ...
      <div className="flex flex-col min-h-screen">
        ...
        <div className="pt-5 pb-10 flex-grow bg-slate-100">
          <div
            className={`${ContentContainer} border-blue-500 bg-slate-50 overflow-x-auto shadow-2xl`}
          >
            ...
            {!isCollapsed && (
              <div className="p-4 grid grid-cols-8 text-base" style={gridStyle}>
